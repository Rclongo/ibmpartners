...
| 10 Myths of Continuous Testing | Intermediate | have a better understanding of the roles that contribute to quality, how continuous testing fits in DevOps, and how large or complex systems can benefit from continuous testing practices. | 1 Hora | WEBINAR
...
4) Webcasts pontuais de assuntos de DevOps (webex)
5) Reunião de Detalhamento para Jornada DevOps
